...
# read in force plate calibrations
# // force plate a calibration data
fpa_cal = pd.read_csv("fp_cal/fpa.csv", header=None).to_numpy()
# V0 = 10
# gain = 4000
# offsets = np.array([0.0004318, -0.0006096, -0.0413766])  # !! must be changed for fp_a

# // force plate b calibration data
fpb_cal = pd.read_csv("fp_cal/fpb.csv", header=None).to_numpy()
V0 = 10
gain = 4000
offsets = np.array([0.0004318, -0.0006096, -0.0413766])
